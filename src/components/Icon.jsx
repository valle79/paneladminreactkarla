...
const FALLBACK = {
  ...
  'money-bag': (
    <>
      ...
      <path d="M12 6.5v11" />
      <path d="M15.2 9.2h-3.6a1.6 1.6 0 0 0 0 3.2h.8a1.6 1.6 0 0 1 0 3.2H8.8" />
    </>
  ),
  'shopping-cart': (
    <>
  ...
  'user-male-circle': (
    <>
      ...
      <path d="M5.2 20.1a8 8 0 0 1 13.6 0" />
    </>
  ),
  'price-tag': (
    <>
  ...
  globe: (
    <>
      <circle cx="12" cy="12" r="9.5" />
      <path d="M12 2.5a14.5 14.5 0 0 0 0 19 14.5 14.5 0 0 0 0-19" />
      <path d="M2.5 12h19" />
    </>
  ),
  'wifi-off': (
  ...
  ruler: (
    <>
      <path d="M21.3 8.7 15.3 2.7a1 1 0 0 0-1.4 0l-8.6 8.6a1 1 0 0 0 0 1.4l6 6a1 1 0 0 0 1.4 0l8.6-8.6a1 1 0 0 0 0-1.4Z" />
      <path d="M8 10l1.5 1.5" />
      <path d="M11 7l1.5 1.5" />
...
export default function Icon({ name, size = 16, title, className = '', style: extraStyle }) {
  const px = Math.max(64, Math.round(size * 4));
  const url = `${CDN}${px}/${name}.png`;
  const [failed, setFailed] = useState(false);
  const node = FALLBACK[name] ?? null;
        ...
        <>
          <span
            ...
            style={{
              ...
              WebkitMask: `no-repeat center / contain url(${url})`,
              mask: `no-repeat center / contain url(${url})`,
            }}
          />
          <img
            src={url}
